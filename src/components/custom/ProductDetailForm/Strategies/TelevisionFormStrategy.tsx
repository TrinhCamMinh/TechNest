        ...
        return (
            <>
                ...
                <div className="h-full flex flex-col gap-8">
                    ...
                    <label className="input input-bordered flex items-center gap-2">
                        Type Of Televsion
                        <input type="text" defaultValue={isPrefilledDataFromDb ? data.type_of_television : 0} className="grow" placeholder="Daisy" readOnly={isViewOnly} ref={isEdit ? typeOfTelevisionRef : undefined} />
                    </label>
                    <label className="input input-bordered flex items-center gap-2">
                        Screen Size
